...
fn test_cmpb_immediate_0xC1() {
    ...
    cpu.memory_bus().borrow_mut().write(0xC800, 0xC1); // CMPB immediate
...
fn test_cmpb_direct_0xD1() {
    ...
    cpu.memory_bus().borrow_mut().write(0xC800, 0xD1); // CMPB direct
...
fn test_cmpb_extended_0xF1() {
    ...
    cpu.memory_bus().borrow_mut().write(0xC800, 0xF1); // CMPB extended
...
fn test_cmpb_indexed_0xE1() {
    ...
    cpu.memory_bus().borrow_mut().write(0xC800, 0xE1); // CMPB indexed
