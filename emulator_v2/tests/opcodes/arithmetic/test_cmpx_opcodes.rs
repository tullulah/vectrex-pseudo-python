...
fn test_cmpx_immediate_0x8C() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x8C); // CMPX immediate
    cpu.memory_bus_mut().write(0xC801, 0x12); // High byte of compare value
    cpu.memory_bus_mut().write(0xC802, 0x34); // Low byte of compare value
...
fn test_cmpx_immediate_greater() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x8C); // CMPX immediate
    cpu.memory_bus_mut().write(0xC801, 0x10); // High byte of compare value
    cpu.memory_bus_mut().write(0xC802, 0x00); // Low byte of compare value
...
fn test_cmpx_immediate_less() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x8C); // CMPX immediate
    cpu.memory_bus_mut().write(0xC801, 0x20); // High byte of compare value
    cpu.memory_bus_mut().write(0xC802, 0x00); // Low byte of compare value
...
fn test_cmpx_direct_0x9C() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x9C); // CMPX direct
...
fn test_cmpx_extended_0xBC() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0xBC); // CMPX extended
...
fn test_cmpx_indexed_0xAC() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0xAC); // CMPX indexed
    cpu.memory_bus_mut().write(0xC801, 0xA4); // ,Y addressing mode
...
fn test_cmpx_overflow_case() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x8C); // CMPX immediate
    cpu.memory_bus_mut().write(0xC801, 0x00); // High byte
    cpu.memory_bus_mut().write(0xC802, 0x01); // Low byte
