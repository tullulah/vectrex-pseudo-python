...
fn test_anda_indexed_0xa4() {
    ...
    memory_bus.borrow_mut().write(0xC801, 0x04); // ,X postbyte
...
fn test_eora_indexed_0xa8() {
    ...
    memory_bus.borrow_mut().write(0xC811, 0x24); // ,Y postbyte
...
fn test_oraa_indexed_0xaa() {
    ...
    memory_bus.borrow_mut().write(0xC821, 0x44); // ,U postbyte
...
fn test_suba_indexed_0xa0() {
    ...
    memory_bus.borrow_mut().write(0xC831, 0x04); // ,X postbyte
...
fn test_adda_indexed_overflow_0xab() {
    ...
    memory_bus.borrow_mut().write(0xC841, 0x04); // ,X postbyte
...
fn test_adda_indexed_carry_0xab() {
    ...
    memory_bus.borrow_mut().write(0xC851, 0x04); // ,X postbyte
...
fn test_anda_zero_result_0xa4() {
    ...
    memory_bus.borrow_mut().write(0xC861, 0x04); // ,X postbyte
