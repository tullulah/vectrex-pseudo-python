...
fn test_cmpa_immediate_0x81() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x81); // CMPA immediate
...
fn test_cmpa_direct_0x91() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x91); // CMPA direct
...
fn test_cmpa_extended_0xB1() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0xB1); // CMPA extended
...
fn test_cmpa_indexed_0xA1() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0xA1); // CMPA indexed
