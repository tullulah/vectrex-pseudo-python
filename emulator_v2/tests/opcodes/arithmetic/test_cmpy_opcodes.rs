...
fn test_cmpy_immediate_0x10_8C() {
    ...
    // C++ Original: CMPY #$1234 with Y=$1234 (equal) - prefixed instruction
    ...
    cpu.memory_bus_mut().write(0xC801, 0x8C); // CMPY immediate
...
fn test_cmpy_direct_0x10_9C() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x10); // Page 1 prefix
    cpu.memory_bus_mut().write(0xC801, 0x9C); // CMPY direct
...
fn test_cmpy_extended_0x10_BC() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x10); // Page 1 prefix
    cpu.memory_bus_mut().write(0xC801, 0xBC); // CMPY extended
...
fn test_cmpy_indexed_0x10_AC() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x10); // Page 1 prefix
    cpu.memory_bus_mut().write(0xC801, 0xAC); // CMPY indexed
