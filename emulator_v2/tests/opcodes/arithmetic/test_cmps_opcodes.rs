...
fn test_cmps_immediate_0x11_8C() {
    ...
    cpu.memory_bus_mut().write(0xC801, 0x8C); // CMPS immediate
...
fn test_cmps_direct_0x11_9C() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x11); // Page 2 prefix
    cpu.memory_bus_mut().write(0xC801, 0x9C); // CMPS direct
...
fn test_cmps_extended_0x11_BC() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x11); // Page 2 prefix
    cpu.memory_bus_mut().write(0xC801, 0xBC); // CMPS extended
...
fn test_cmps_indexed_0x11_AC() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x11); // Page 2 prefix
    cpu.memory_bus_mut().write(0xC801, 0xAC); // CMPS indexed
...
fn test_cmps_system_stack_values() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x11); // Page 2 prefix
    cpu.memory_bus_mut().write(0xC801, 0x8C); // CMPS immediate
    cpu.memory_bus_mut().write(0xC802, 0x80); // High byte
