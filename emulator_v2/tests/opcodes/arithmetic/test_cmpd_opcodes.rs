...
fn test_cmpd_immediate_0x10_83() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x10); // Page 1 prefix
    cpu.memory_bus_mut().write(0xC801, 0x83); // CMPD immediate
...
fn test_cmpd_direct_0x10_93() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x10); // Page 1 prefix
    cpu.memory_bus_mut().write(0xC801, 0x93); // CMPD direct
...
fn test_cmpd_extended_0x10_B3() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x10); // Page 1 prefix
    cpu.memory_bus_mut().write(0xC801, 0xB3); // CMPD extended
...
fn test_cmpd_indexed_0x10_A3() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x10); // Page 1 prefix
    cpu.memory_bus_mut().write(0xC801, 0xA3); // CMPD indexed
...
fn test_cmpd_a_b_separate_registers() {
    ...
    cpu.memory_bus_mut().write(0xC800, 0x10); // Page 1 prefix
    cpu.memory_bus_mut().write(0xC801, 0x83); // CMPD immediate
    cpu.memory_bus_mut().write(0xC802, 0xAB); // High byte
    cpu.memory_bus_mut().write(0xC803, 0xCD); // Low byte
