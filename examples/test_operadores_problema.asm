; --- Motorola 6809 backend (Vectrex) title='TEST_OPERADORES_PROBLEMA' origin=$0000 ---
        ORG $0000
;***************************************************************************
; DEFINE SECTION
;***************************************************************************
...
LOOP_BODY:
    ; DEBUG: Processing 28 statements in loop() body
...
DIV_Q   EQU RESULT+22
DIV_R   EQU RESULT+24
VAR_OBJ_X EQU $C900+0
VAR_OBJ_Y EQU $C900+2
VAR_SIZE EQU $C900+4
VAR_TEMP EQU $C900+6
VAR_TEST_FRAME EQU $C900+8
VAR_TEST_PHASE EQU $C900+10
VAR_TX EQU $C900+12
VAR_TY EQU $C900+14
VAR_VALUE EQU $C900+16
...
VLINE_DX EQU RESULT+18
VLINE_DY EQU RESULT+19
