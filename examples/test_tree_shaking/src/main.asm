; --- Motorola 6809 backend (Vectrex) title='Tree Shaking Test' origin=$0000 ---
        ORG $0000
;***************************************************************************
; DEFINE SECTION
;***************************************************************************
...
VAR_PLAYER_X         EQU $C880+$0C   ; User variable (2 bytes)
VAR_ARG0             EQU $C880+$0E   ; Function argument 0 (2 bytes)
VAR_ARG1             EQU $C880+$10   ; Function argument 1 (2 bytes)
VAR_ARG2             EQU $C880+$12   ; Function argument 2 (2 bytes)
VAR_ARG3             EQU $C880+$14   ; Function argument 3 (2 bytes)
...
MAIN:
    ...
    ; VPy_LINE:9
UNUSED_MODULE_USED_FUNCTION: ; function
; --- function unused_module_used_function ---
    ; VPy_LINE:10
    LDD #42
    STD RESULT
    RTS
...
; NATIVE_CALL: VECTREX_WAIT_RECAL at line 17
    ...
    ; VPy_LINE:19
    JSR UNUSED_MODULE_USED_FUNCTION
    LDX RESULT
    STX 0 ,S
