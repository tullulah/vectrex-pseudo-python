...
; ROM: 262144 bytes
; Multibank cartridge: 16 banks (16KB each)
; Helpers bank: 15 (fixed bank at $4000-$7FFF)
...
; Bank 0 ($0000) is active; fixed bank 15 ($4000-$7FFF) always visible
    JMP MAIN
...
LOOP_BODY:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_980426358253096195      ; Pointer to string in helpers bank
    STX VAR_ARG2
...
PRINT_TEXT_STR_980426358253096195:
    FCC "16 BANKS - 256KB ROM"
