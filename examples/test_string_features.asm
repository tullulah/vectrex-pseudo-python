; --- Motorola 6809 backend (Vectrex) title='String Features Test' origin=$0000 ---
        ORG $0000
;***************************************************************************
; DEFINE SECTION
;***************************************************************************
...
; NATIVE_CALL: VECTREX_WAIT_RECAL at line 11
    ...
    ; VPy_LINE:14
    LDX #STR_2    ; String literal pointer
    STX 0 ,S
    ; DEBUG: Statement 2 - Discriminant(7)
    ; VPy_LINE:17
; NATIVE_CALL: DEBUG_PRINT_STR("LITERAL") at line 17
    LDX #STR_1    ; Load string literal pointer
    STX $C002
    LDA #$FD
    STA $C001
    CLR $C004
    ...
    LDD VAR_GLOBAL_STR
    STD RESULT
; NATIVE_CALL: DEBUG_PRINT_STR(global_str) at line 20
    LDD RESULT
    STD $C002
    LDA #$FD
    STA $C001
    LDX #DEBUG_LABEL_GLOBAL_STR
    STX $C004
    BRA DEBUG_SKIP_DATA_1
DEBUG_LABEL_GLOBAL_STR:
    FCC "global_str"
    FCB $00
DEBUG_SKIP_DATA_1:
    LDD #0
    ...
    LDD 0 ,S
    STD RESULT
; NATIVE_CALL: DEBUG_PRINT_STR(local_str) at line 23
    LDD RESULT
    STD $C002
    LDA #$FD
    STA $C001
    LDX #DEBUG_LABEL_LOCAL_STR
    STX $C004
    BRA DEBUG_SKIP_DATA_2
DEBUG_LABEL_LOCAL_STR:
    FCC "local_str"
    FCB $00
DEBUG_SKIP_DATA_2:
    LDD #0
...
VAR_GLOBAL_STR EQU $CF10+0
VAR_LOCAL_STR EQU $CF10+2
