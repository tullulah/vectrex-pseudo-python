...
; X bounds: min=-22, max=35, width=57
; Center: (6, 7)

_PLAYER_WIDTH EQU 57
_PLAYER_CENTER_X EQU 6
_PLAYER_CENTER_Y EQU 7

_PLAYER_VECTORS:  ; Main entry
_PLAYER_PATH0:    ; Path 0
    FCB 127              ; path0: intensity
    FCB $16,$E4,0,0        ; path0: header (y=22, x=-28, relative to center)
