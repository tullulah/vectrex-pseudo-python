...
VAR_JOY_Y            EQU $C880+$31   ; User variable: JOY_Y (2 bytes)
VAR_JOY_X            EQU $C880+$33   ; User variable: JOY_X (2 bytes)
VAR_B2               EQU $C880+$35   ; User variable: B2 (2 bytes)
VAR_POS_X            EQU $C880+$37   ; User variable: POS_X (2 bytes)
VAR_JOYSTICK1_STATE  EQU $C880+$39   ; User variable: JOYSTICK1_STATE (2 bytes)
VAR_POS_Y            EQU $C880+$3B   ; User variable: POS_Y (2 bytes)
VAR_B1               EQU $C880+$3D   ; User variable: B1 (2 bytes)
VAR_B4               EQU $C880+$3F   ; User variable: B4 (2 bytes)
VAR_B3               EQU $C880+$41   ; User variable: B3 (2 bytes)
