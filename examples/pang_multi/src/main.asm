...
.CMP_1_END:
    ...
    LDD RESULT
    LBEQ IF_NEXT_3
    ; PLAY_MUSIC("pang_theme") - play music asset (index=2)
...
.CMP_10_END:
    ...
    LDD RESULT
    LBEQ IF_NEXT_8
    ; PLAY_MUSIC("map_theme") - play music asset (index=1)
...
.CMP_15_END:
    ...
    ; ERROR: Level 'fuji_level1_v2' not found in assets
    LDD #0
    STD RESULT
    LBRA IF_END_13
IF_NEXT_14:
...
.CMP_56_END:
    ...
    LBEQ IF_NEXT_54
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: fuji_bg (index=14, 6 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_57_END:
    ...
    LBEQ IF_NEXT_55
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: keirin_bg (index=16, 3 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_58_END:
    ...
    LBEQ IF_NEXT_56
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: buddha_bg (index=12, 4 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_60_END:
    ...
    LBEQ IF_NEXT_58
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: ayers_bg (index=4, 3 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_62_END:
    ...
    LBEQ IF_NEXT_60
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: leningrad_bg (index=18, 5 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_63_END:
    ...
    LBEQ IF_NEXT_61
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: paris_bg (index=27, 5 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_64_END:
    ...
    LBEQ IF_NEXT_62
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: london_bg (index=22, 4 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_65_END:
    ...
    LBEQ IF_NEXT_63
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: barcelona_bg (index=6, 4 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_66_END:
    ...
    LBEQ IF_NEXT_64
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: athens_bg (index=3, 7 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_67_END:
    ...
    LBEQ IF_NEXT_65
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: pyramids_bg (index=36, 4 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_68_END:
    ...
    LBEQ IF_NEXT_66
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: kilimanjaro_bg (index=17, 4 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_69_END:
    ...
    LBEQ IF_NEXT_67
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: newyork_bg (index=25, 5 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_70_END:
    ...
    LBEQ IF_NEXT_68
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: mayan_bg (index=24, 5 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
IF_NEXT_69:
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: easter_bg (index=13, 5 paths)
    LDD #0
    STD RESULT
    LDA RESULT+1  ; X position (low byte)
    STA TMPPTR    ; Save X to temporary storage
...
.CMP_106_END:
    ...
    LBEQ IF_NEXT_126
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: bubble_huge (index=8, 1 paths)
    LDX #VAR_ENEMY_X_DATA  ; Array data
    PSHS X
    LDD VAR_I
    STD RESULT
...
.CMP_107_END:
    ...
    LBEQ IF_NEXT_127
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: bubble_large (index=9, 1 paths)
    LDX #VAR_ENEMY_X_DATA  ; Array data
    PSHS X
    LDD VAR_I
    STD RESULT
...
.CMP_108_END:
    ...
    LBEQ IF_NEXT_128
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: bubble_medium (index=10, 1 paths)
    LDX #VAR_ENEMY_X_DATA  ; Array data
    PSHS X
    LDD VAR_I
    STD RESULT
...
IF_NEXT_128:
    ; DRAW_VECTOR: Draw vector asset at position
    ; Asset: bubble_small (index=11, 1 paths)
    LDX #VAR_ENEMY_X_DATA  ; Array data
    PSHS X
    LDD VAR_I
    STD RESULT
...
; ================================================
; BANK #1 - 0 function(s), 39 asset(s)
; ================================================
    ORG $0000  ; Sequential bank model

;***************************************************************************
; ASSETS IN BANK #1 (50 assets)
;***************************************************************************
...
; Total: 39 vectors, 3 music, 8 sfx, 0 levels
;***************************************************************************
...
;   4 = ayers_bg (Bank #1)
;   5 = ball (Bank #1)
;   6 = barcelona_bg (Bank #1)
;   7 = brick (Bank #1)
;   8 = bubble_huge (Bank #1)
;   9 = bubble_large (Bank #1)
;   10 = bubble_medium (Bank #1)
;   11 = bubble_small (Bank #1)
;   12 = buddha_bg (Bank #1)
;   13 = easter_bg (Bank #1)
;   14 = fuji_bg (Bank #1)
;   15 = hook (Bank #1)
;   16 = keirin_bg (Bank #1)
;   17 = kilimanjaro_bg (Bank #1)
;   18 = leningrad_bg (Bank #1)
;   19 = location (Bank #1)
;   20 = location_marker (Bank #1)
;   21 = logo (Bank #1)
;   22 = london_bg (Bank #1)
;   23 = map (Bank #1)
;   24 = mayan_bg (Bank #1)
;   25 = newyork_bg (Bank #1)
;   26 = pang_logo (Bank #1)
;   27 = paris_bg (Bank #1)
;   28 = player (Bank #1)
;   29 = player_left (Bank #1)
;   30 = player_right (Bank #1)
;   31 = player_walk_1 (Bank #1)
;   32 = player_walk_2 (Bank #1)
;   33 = player_walk_3 (Bank #1)
;   34 = player_walk_4 (Bank #1)
;   35 = player_walk_5 (Bank #1)
;   36 = pyramids_bg (Bank #1)
;   37 = taj_bg (Bank #1)
;   38 = test (Bank #1)
...
VECTOR_ADDR_TABLE:
    ...
    FDB _LOCATION_VECTORS    ; location
    ...
    FDB _PLAYER_LEFT_VECTORS    ; player_left
    FDB _PLAYER_RIGHT_VECTORS    ; player_right
...
MUSIC_ADDR_TABLE:
    FDB _FUJI_THEME_MUSIC    ; fuji_theme
