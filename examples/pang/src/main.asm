...
; --- function draw_map_screen ---
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 226
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
; --- function draw_level_background ---
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 268
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
; --- function draw_game_level ---
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 311
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
IF_END_215:
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 373
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
CE_304:
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 402
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
DSVEX_CALL_307:
    ...
    LDD VAR_HOOK_GUN_X
    STD RESULT
; NATIVE_CALL: DEBUG_PRINT(hook_gun_x) at line 406
    LDD RESULT
    STA $C002
    STB $C000
    LDA #$FE
    STA $C001
    LDX #DEBUG_LABEL_HOOK_GUN_X
    STX $C004
    BRA DEBUG_SKIP_DATA_308
DEBUG_LABEL_HOOK_GUN_X:
    FCC "hook_gun_x"
    FCB $00
DEBUG_SKIP_DATA_308:
    LDD #0
...
CE_371:
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 499
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
CE_385:
    ...
    LBEQ IF_NEXT_383
    ; VPy_LINE:526
; NATIVE_CALL: J1_BUTTON_1 at line 526
    JSR J1B1_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_383:
    ; VPy_LINE:531
; NATIVE_CALL: J1_BUTTON_1 at line 531
    JSR J1B1_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_397:
    ...
    LBEQ IF_NEXT_395
    ; VPy_LINE:537
; NATIVE_CALL: J1_BUTTON_2 at line 537
    JSR J1B2_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_395:
    ; VPy_LINE:540
; NATIVE_CALL: J1_BUTTON_2 at line 540
    JSR J1B2_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_409:
    ...
    LBEQ IF_NEXT_407
    ; VPy_LINE:545
; NATIVE_CALL: J1_BUTTON_3 at line 545
    JSR J1B3_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_407:
    ; VPy_LINE:548
; NATIVE_CALL: J1_BUTTON_3 at line 548
    JSR J1B3_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_421:
    ...
    LBEQ IF_NEXT_419
    ; VPy_LINE:553
; NATIVE_CALL: J1_BUTTON_4 at line 553
    JSR J1B4_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_419:
    ; VPy_LINE:556
; NATIVE_CALL: J1_BUTTON_4 at line 556
    JSR J1B4_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
