...
IF_END_92:
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 178
...
; PRINT_TEXT(x, y, text) - uses BIOS defaults
    ...
    LDD RESULT
    STD VAR_ARG2
; NATIVE_CALL: VECTREX_PRINT_TEXT at line 179
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 182
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
; PRINT_TEXT(x, y, text) - uses BIOS defaults
    ...
    LDD RESULT
    STD VAR_ARG2
; NATIVE_CALL: VECTREX_PRINT_TEXT at line 183
    JSR VECTREX_PRINT_TEXT
    CLRA
    CLRB
    STD RESULT
...
; --- function draw_map_screen ---
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 225
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
; DRAW_VECTOR("logo", x, y) - 7 path(s) at position
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 252
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
; --- function draw_level_background ---
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 270
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
CE_304:
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 398
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
CE_370:
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 490
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
CE_384:
    ...
    LBEQ IF_NEXT_382
    ; VPy_LINE:517
; NATIVE_CALL: J1_BUTTON_1 at line 517
    JSR J1B1_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_382:
    ; VPy_LINE:522
; NATIVE_CALL: J1_BUTTON_1 at line 522
    JSR J1B1_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_396:
    ...
    LBEQ IF_NEXT_394
    ; VPy_LINE:528
; NATIVE_CALL: J1_BUTTON_2 at line 528
    JSR J1B2_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_394:
    ; VPy_LINE:531
; NATIVE_CALL: J1_BUTTON_2 at line 531
    JSR J1B2_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_406:
    ; VPy_LINE:539
; NATIVE_CALL: J1_BUTTON_3 at line 539
    JSR J1B3_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_420:
    ...
    LBEQ IF_NEXT_418
    ; VPy_LINE:544
; NATIVE_CALL: J1_BUTTON_4 at line 544
    JSR J1B4_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_418:
    ; VPy_LINE:547
; NATIVE_CALL: J1_BUTTON_4 at line 547
    JSR J1B4_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
VAR_INTENSITYVAL EQU $CF10+34
VAR_COUNTDOWN_TIMER EQU $CF10+36
VAR_COUNTDOWN_ACTIVE EQU $CF10+38
VAR_MAX_LEVEL_UNLOCKED EQU $CF10+40
