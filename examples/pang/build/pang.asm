...
; NATIVE_CALL: VECTREX_PRINT_TEXT at line 178
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 181
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
; PRINT_TEXT(x, y, text) - uses BIOS defaults
    ...
    LDD RESULT
    STD VAR_ARG2
; NATIVE_CALL: VECTREX_PRINT_TEXT at line 182
    JSR VECTREX_PRINT_TEXT
    CLRA
    CLRB
    STD RESULT
...
; --- function draw_title_screen ---
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 248
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
CE_304:
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 397
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
CE_370:
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 489
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
CE_384:
    ...
    LBEQ IF_NEXT_382
    ; VPy_LINE:516
; NATIVE_CALL: J1_BUTTON_1 at line 516
    JSR J1B1_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_382:
    ; VPy_LINE:521
; NATIVE_CALL: J1_BUTTON_1 at line 521
    JSR J1B1_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_396:
    ...
    LBEQ IF_NEXT_394
    ; VPy_LINE:527
; NATIVE_CALL: J1_BUTTON_2 at line 527
    JSR J1B2_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_394:
    ; VPy_LINE:530
; NATIVE_CALL: J1_BUTTON_2 at line 530
    JSR J1B2_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_408:
    ...
    LBEQ IF_NEXT_406
    ; VPy_LINE:535
; NATIVE_CALL: J1_BUTTON_3 at line 535
    JSR J1B3_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_406:
    ; VPy_LINE:538
; NATIVE_CALL: J1_BUTTON_3 at line 538
    JSR J1B3_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_420:
    ...
    LBEQ IF_NEXT_418
    ; VPy_LINE:543
; NATIVE_CALL: J1_BUTTON_4 at line 543
    JSR J1B4_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_418:
    ; VPy_LINE:546
; NATIVE_CALL: J1_BUTTON_4 at line 546
    JSR J1B4_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
VAR_MAX_LEVEL_UNLOCKED EQU $C8C0+38
VAR_JOYSTICK_POLL_COUNTER EQU $C8C0+40
VAR_HOOK_ACTIVE EQU $C8C0+42
VAR_HOOK_X EQU $C8C0+44
VAR_HOOK_Y EQU $C8C0+46
VAR_HOOK_GUN_X EQU $C8C0+48
VAR_HOOK_GUN_Y EQU $C8C0+50
VAR_HOOK_INIT_Y EQU $C8C0+52
VAR_PLAYER_X EQU $C8C0+54
VAR_PLAYER_SPEED EQU $C8C0+56
VAR_MOVE_SPEED EQU $C8C0+58
VAR_ABS_JOY EQU $C8C0+60
VAR_SPEED_MULTIPLIER EQU $C8C0+62
VAR_PLAYER_ANIM_FRAME EQU $C8C0+64
VAR_PLAYER_ANIM_COUNTER EQU $C8C0+66
VAR_PLAYER_FACING EQU $C8C0+68
VAR_ENEMY_ACTIVE_DATA EQU $C8C0+70  ; Array data (8 elements)
VAR_ENEMY_X_DATA EQU $C8C0+86  ; Array data (8 elements)
VAR_ENEMY_Y_DATA EQU $C8C0+102  ; Array data (8 elements)
VAR_ENEMY_VX_DATA EQU $C8C0+118  ; Array data (8 elements)
VAR_ENEMY_VY_DATA EQU $C8C0+134  ; Array data (8 elements)
VAR_ENEMY_SIZE_DATA EQU $C8C0+150  ; Array data (8 elements)
