...
IF_END_4:
    ...
    ; VPy_LINE:39
; NATIVE_CALL: J1_BUTTON_1 at line 39
...
.j1b1_done:
    ...
    STX 0 ,S
    ; VPy_LINE:40
; NATIVE_CALL: J1_BUTTON_2 at line 40
...
.j1b2_done:
    ...
    STX 2 ,S
    ; VPy_LINE:41
; NATIVE_CALL: J1_BUTTON_3 at line 41
...
.j1b3_done:
    ...
    STX 4 ,S
    ; VPy_LINE:42
; NATIVE_CALL: J1_BUTTON_4 at line 42
...
CE_31:
    ...
    LBEQ IF_NEXT_29
    ; VPy_LINE:52
; NATIVE_CALL: STOP_MUSIC at line 52
...
; --- function draw_map_screen ---
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 65
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
; DRAW_VECTOR("logo", x, y) - 16 path(s) at position
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 87
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
