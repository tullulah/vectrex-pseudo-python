...
CE_304:
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 399
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
CE_370:
    ...
    LDD RESULT
    STD VAR_ARG0
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 491
    JSR VECTREX_SET_INTENSITY
    CLRA
    CLRB
    STD RESULT
...
CE_384:
    ...
    LBEQ IF_NEXT_382
    ; VPy_LINE:518
; NATIVE_CALL: J1_BUTTON_1 at line 518
    JSR J1B1_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_382:
    ; VPy_LINE:523
; NATIVE_CALL: J1_BUTTON_1 at line 523
    JSR J1B1_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_396:
    ...
    LBEQ IF_NEXT_394
    ; VPy_LINE:529
; NATIVE_CALL: J1_BUTTON_2 at line 529
    JSR J1B2_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_394:
    ; VPy_LINE:532
; NATIVE_CALL: J1_BUTTON_2 at line 532
    JSR J1B2_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_408:
    ...
    LBEQ IF_NEXT_406
    ; VPy_LINE:537
; NATIVE_CALL: J1_BUTTON_3 at line 537
    JSR J1B3_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_406:
    ; VPy_LINE:540
; NATIVE_CALL: J1_BUTTON_3 at line 540
    JSR J1B3_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
CE_420:
    ...
    LBEQ IF_NEXT_418
    ; VPy_LINE:545
; NATIVE_CALL: J1_BUTTON_4 at line 545
    JSR J1B4_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
...
IF_NEXT_418:
    ; VPy_LINE:548
; NATIVE_CALL: J1_BUTTON_4 at line 548
    JSR J1B4_BUILTIN
    STD RESULT
    LDD RESULT
    STD TMPLEFT
