...
VAR_SPEED            EQU $C880+$3B   ; User variable: speed (2 bytes)
VAR_STATE_MAP        EQU $C880+$3D   ; User variable: STATE_MAP (2 bytes)
VAR_MIN_BOUNCE_VY    EQU $C880+$3F   ; User variable: MIN_BOUNCE_VY (2 bytes)
VAR_CURRENT_MUSIC    EQU $C880+$41   ; User variable: current_music (2 bytes)
VAR_PREV_JOY_Y       EQU $C880+$43   ; User variable: prev_joy_y (2 bytes)
VAR_HOOK_ACTIVE      EQU $C880+$45   ; User variable: hook_active (2 bytes)
VAR_HOOK_GUN_Y       EQU $C880+$47   ; User variable: hook_gun_y (2 bytes)
VAR_START_Y          EQU $C880+$49   ; User variable: start_y (2 bytes)
VAR_ENEMY_SIZE       EQU $C880+$4B   ; User variable: enemy_size (2 bytes)
VAR_LOCATION_Y_COORDS EQU $C880+$4D   ; User variable: location_y_coords (2 bytes)
VAR_MIRROR_MODE      EQU $C880+$4F   ; User variable: mirror_mode (2 bytes)
VAR_TITLE_STATE      EQU $C880+$51   ; User variable: title_state (2 bytes)
VAR_MOVE_SPEED       EQU $C880+$53   ; User variable: move_speed (2 bytes)
VAR_HOOK_Y           EQU $C880+$55   ; User variable: hook_y (2 bytes)
VAR_COUNTDOWN_TIMER  EQU $C880+$57   ; User variable: countdown_timer (2 bytes)
VAR_PLAYER_ANIM_FRAME EQU $C880+$59   ; User variable: player_anim_frame (2 bytes)
VAR_ENEMY_VX         EQU $C880+$5B   ; User variable: enemy_vx (2 bytes)
VAR_END_Y            EQU $C880+$5D   ; User variable: end_y (2 bytes)
VAR_CURRENT_LOCATION EQU $C880+$5F   ; User variable: current_location (2 bytes)
VAR_PREV_JOY_X       EQU $C880+$61   ; User variable: prev_joy_x (2 bytes)
VAR_GROUND_Y         EQU $C880+$63   ; User variable: GROUND_Y (2 bytes)
VAR_MAX_ENEMIES      EQU $C880+$65   ; User variable: MAX_ENEMIES (2 bytes)
VAR_JOY_X            EQU $C880+$67   ; User variable: joy_x (2 bytes)
VAR_SCREEN           EQU $C880+$69   ; User variable: screen (2 bytes)
VAR_JOY_Y            EQU $C880+$6B   ; User variable: joy_y (2 bytes)
VAR_HOOK_INIT_Y      EQU $C880+$6D   ; User variable: hook_init_y (2 bytes)
VAR_HOOK_MAX_Y       EQU $C880+$6F   ; User variable: hook_max_y (2 bytes)
VAR_ENEMY_VY         EQU $C880+$71   ; User variable: enemy_vy (2 bytes)
VAR_JOYSTICK1_STATE  EQU $C880+$73   ; User variable: joystick1_state (2 bytes)
...
VAR_LEVEL_ENEMY_COUNT EQU $C880+$79   ; User variable: level_enemy_count (2 bytes)
VAR_PLAYER_ANIM_SPEED EQU $C880+$7B   ; User variable: player_anim_speed (2 bytes)
VAR_PLAYER_Y         EQU $C880+$7D   ; User variable: player_y (2 bytes)
VAR_LEVEL_ENEMY_SPEED EQU $C880+$7F   ; User variable: level_enemy_speed (2 bytes)
VAR_PLAYER_ANIM_COUNTER EQU $C880+$81   ; User variable: player_anim_counter (2 bytes)
VAR_LOCATION_GLOW_DIRECTION EQU $C880+$83   ; User variable: location_glow_direction (2 bytes)
VAR_LOCATION_GLOW_INTENSITY EQU $C880+$85   ; User variable: location_glow_intensity (2 bytes)
VAR_TITLE_INTENSITY  EQU $C880+$87   ; User variable: title_intensity (2 bytes)
VAR_STATE_TITLE      EQU $C880+$89   ; User variable: STATE_TITLE (2 bytes)
VAR_LOCATION_X_COORDS EQU $C880+$8B   ; User variable: location_x_coords (2 bytes)
VAR_LOC_Y            EQU $C880+$8D   ; User variable: loc_y (2 bytes)
VAR_START_X          EQU $C880+$8F   ; User variable: start_x (2 bytes)
VAR_GRAVITY          EQU $C880+$91   ; User variable: GRAVITY (2 bytes)
VAR_ENEMY_X          EQU $C880+$93   ; User variable: enemy_x (2 bytes)
VAR_LOCATION_NAMES   EQU $C880+$95   ; User variable: location_names (2 bytes)
VAR_HOOK_X           EQU $C880+$97   ; User variable: hook_x (2 bytes)
VAR_HOOK_GUN_X       EQU $C880+$99   ; User variable: hook_gun_x (2 bytes)
VAR_LOC_X            EQU $C880+$9B   ; User variable: loc_x (2 bytes)
VAR_ACTIVE_COUNT     EQU $C880+$9D   ; User variable: active_count (2 bytes)
VAR_STATE_GAME       EQU $C880+$9F   ; User variable: STATE_GAME (2 bytes)
VAR_COUNT            EQU $C880+$A1   ; User variable: count (2 bytes)
VAR_ABS_JOY          EQU $C880+$A3   ; User variable: abs_joy (2 bytes)
VAR_PLAYER_FACING    EQU $C880+$A5   ; User variable: player_facing (2 bytes)
VAR_BOUNCE_DAMPING   EQU $C880+$A7   ; User variable: BOUNCE_DAMPING (2 bytes)
VAR_I                EQU $C880+$A9   ; User variable: i (2 bytes)
VAR_ENEMY_Y          EQU $C880+$AB   ; User variable: enemy_y (2 bytes)
VAR_ENEMY_ACTIVE     EQU $C880+$AD   ; User variable: enemy_active (2 bytes)
VAR_PLAYER_X         EQU $C880+$AF   ; User variable: player_x (2 bytes)
VAR_NUM_LOCATIONS    EQU $C880+$B1   ; User variable: num_locations (2 bytes)
VAR_ANIM_THRESHOLD   EQU $C880+$B3   ; User variable: anim_threshold (2 bytes)
VAR_END_X            EQU $C880+$B5   ; User variable: end_x (2 bytes)
