...
PLAYER_SHOW: ; function
; --- function Player_show ---
    ; VPy_LINE:17
    ; FieldAccess self.x (struct Player field offset 0)
...
; NATIVE_CALL: DEBUG_PRINT at line 17
    ...
    STD RESULT
    ; VPy_LINE:18
    ; FieldAccess self.y (struct Player field offset 2)
    LDX VAR_ARG0    ; Load struct pointer
    LDD 2,X        ; Read field value
    STD RESULT
; NATIVE_CALL: DEBUG_PRINT at line 18
    LDD RESULT
    STB $C000
    LDA #$42
    STA $C001
    ...
    STD RESULT
    ; VPy_LINE:19
    ; FieldAccess self.health (struct Player field offset 4)
    LDX VAR_ARG0    ; Load struct pointer
    LDD 4,X        ; Read field value
    STD RESULT
; NATIVE_CALL: DEBUG_PRINT at line 19
    LDD RESULT
    STB $C000
    LDA #$42
    STA $C001
...
; --- function PLAYER_INIT ---
    ...
    LDD VAR_ARG0
    STD 0,S ; param start_x
    LDD VAR_ARG1
    STD 2,S ; param start_y
    ; VPy_LINE:14
    ; pass (no-op)
...
; NATIVE_CALL: VECTREX_WAIT_RECAL at line 25
    ...
    ; VPy_LINE:28
; Struct instantiation: Player (size 6 bytes)
    LEAS -6,S  ; Allocate 6 bytes for struct
    LDD #0
    STD 0,S  ; Zero field at offset 0
    STD 2,S  ; Zero field at offset 2
    STD 4,S  ; Zero field at offset 4
