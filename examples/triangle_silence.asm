...
VECTREX_SILENCE:
    ; Silence AY-3-8912: write 0 to amplitude regs 8,9,10 and mixer (7) disable noise/tone.
    ; VIA ports: A=$D000 (data), B=$D001 (address), CA2/CB2 strobe handled by BIOS normally; emulate minimal sequence.
    ; Set register select then write value. Real hardware needs control line pulses; assuming emulator accepts simple sequence.
    LDA #7
    STA $D001
    LDA #%00111000 ; disable tone+noise all channels (bits 0-5 set)
    STA $D000
    LDA #8
    STA $D001
    CLR $D000
