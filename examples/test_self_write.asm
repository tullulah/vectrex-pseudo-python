; --- Motorola 6809 backend (Vectrex) title='TEST SELF WRITE' origin=$0000 ---
        ORG $0000
;***************************************************************************
; DEFINE SECTION
;***************************************************************************
...
LOOP_BODY:
    LEAS -4,S ; allocate locals
    ; DEBUG: Processing 8 statements in loop() body
...
; NATIVE_CALL: VECTREX_WAIT_RECAL at line 20
    ...
    LDD #10
    STD RESULT
    ; Assign p.x (struct Point offset 0)
    LDD RESULT
    STD 0,S
    ...
    LDD #20
    STD RESULT
    ; Assign p.y (struct Point offset 2)
    LDD RESULT
    STD 2,S
...
; NATIVE_CALL: VECTREX_SET_INTENSITY at line 30
    ...
    ; VPy_LINE:31
    ; FieldAccess p.x (struct Point offset 0)
    LDD 0,S
    STD RESULT
    LDD RESULT
    STD VAR_ARG0
    ; FieldAccess p.y (struct Point offset 2)
    LDD 2,S
    STD RESULT
    LDD RESULT
    STD VAR_ARG1
...
VAR_ARG3 EQU $C8B8
VAR_ARG4 EQU $C8BA
VLINE_DX EQU RESULT+0
VLINE_DY EQU RESULT+1
VLINE_STEPS EQU RESULT+2
VLINE_LIST EQU RESULT+3
DRAW_VEC_X EQU RESULT+5
DRAW_VEC_Y EQU RESULT+6
