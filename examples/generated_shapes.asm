...
VL_SHAPES:
    ...
    FCB $00,$00,CMD_ZERO ; ZERO (Reset0Ref) => origin (0,0)
    FCB $F0,$10,CMD_START ; START to (+16, -16)
    FCB $02,$00,CMD_LINE ; LINE dy=+2 dx=+0 -> (+16, -14)
    FCB $02,$FF,CMD_LINE ; LINE dy=+2 dx=-1 -> (+15, -12)
    FCB $02,$00,CMD_LINE ; LINE dy=+2 dx=+0 -> (+15, -10)
    FCB $02,$FF,CMD_LINE ; LINE dy=+2 dx=-1 -> (+14, -8)
    FCB $02,$FE,CMD_LINE ; LINE dy=+2 dx=-2 -> (+12, -6)
    FCB $02,$FF,CMD_LINE ; LINE dy=+2 dx=-1 -> (+11, -4)
    FCB $01,$FE,CMD_LINE ; LINE dy=+1 dx=-2 -> (+9, -3)
    FCB $01,$FE,CMD_LINE ; LINE dy=+1 dx=-2 -> (+7, -2)
    FCB $01,$FE,CMD_LINE ; LINE dy=+1 dx=-2 -> (+5, -1)
    FCB $01,$FE,CMD_LINE ; LINE dy=+1 dx=-2 -> (+3, +0)
    FCB $00,$FE,CMD_LINE ; LINE dy=+0 dx=-2 -> (+1, +0)
    FCB $00,$FE,CMD_LINE ; LINE dy=+0 dx=-2 -> (-1, +0)
    FCB $00,$FE,CMD_LINE ; LINE dy=+0 dx=-2 -> (-3, +0)
    FCB $FF,$FE,CMD_LINE ; LINE dy=-1 dx=-2 -> (-5, -1)
    FCB $FF,$FE,CMD_LINE ; LINE dy=-1 dx=-2 -> (-7, -2)
    FCB $FF,$FE,CMD_LINE ; LINE dy=-1 dx=-2 -> (-9, -3)
    FCB $FF,$FE,CMD_LINE ; LINE dy=-1 dx=-2 -> (-11, -4)
    FCB $FE,$FF,CMD_LINE ; LINE dy=-2 dx=-1 -> (-12, -6)
    FCB $FE,$FE,CMD_LINE ; LINE dy=-2 dx=-2 -> (-14, -8)
    FCB $FE,$FF,CMD_LINE ; LINE dy=-2 dx=-1 -> (-15, -10)
    FCB $FE,$00,CMD_LINE ; LINE dy=-2 dx=+0 -> (-15, -12)
    FCB $FE,$FF,CMD_LINE ; LINE dy=-2 dx=-1 -> (-16, -14)
    FCB $FE,$00,CMD_LINE ; LINE dy=-2 dx=+0 -> (-16, -16)
