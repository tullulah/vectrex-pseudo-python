; --- Motorola 6809 backend (Vectrex) title='STRUCT METHODS TEST' origin=$0000 ---
        ORG $0000
;***************************************************************************
; DEFINE SECTION
;***************************************************************************
...
POINT_DISTANCE_FROM_ORIGIN: ; function
; --- function Point_distance_from_origin ---
    ; VPy_LINE:12
    ; FieldAccess self.x (TODO: global structs)
    LDD #0
    STD RESULT
    LDD RESULT
    TSTA
...
LOOP_BODY:
    ...
    LDD #10
    STD RESULT
    ; Assign p.x (struct Point offset 2)
    LDD RESULT
    STD 2,S
    ...
    LDD #20
    STD RESULT
    ; Assign p.y (struct Point offset 4)
    LDD RESULT
    STD 4,S
