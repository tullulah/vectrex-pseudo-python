; --- Motorola 6809 backend (Vectrex) title='TEST_POSITIVE_COORDS' origin=$0000 ---
        ORG $0000
;***************************************************************************
; DEFINE SECTION
;***************************************************************************
...
; --- function loop ---
    ...
    LDA #$1E
    LDB #$0A
    JSR Moveto_d ; move to (10, 30)
    LDA #$FF
    JSR Intensity_a
    CLR Vec_Misc_Count
    LDA #$00
    LDB #$46
    JSR Draw_Line_d ; dy=0, dx=70
    CLRA
    CLRB
    STD RESULT
    LDA #$D0
    ...
    LDA #$0A
    LDB #$32
    JSR Moveto_d ; move to (50, 10)
    LDA #$FF
    JSR Intensity_a
    CLR Vec_Misc_Count
    LDA #$46
    LDB #$00
    JSR Draw_Line_d ; dy=70, dx=0
    CLRA
    CLRB
    STD RESULT
    RTS
