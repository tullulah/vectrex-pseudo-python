; --- Motorola 6809 backend (Vectrex) title='RAM Usage Test' origin=$0000 ---
        ORG $0000
;***************************************************************************
; DEFINE SECTION
;***************************************************************************
...
VAR_ARG2             EQU $C880+$18   ; Function argument 2 (2 bytes)
VAR_ARG3             EQU $C880+$1A   ; Function argument 3 (2 bytes)
...
; PRINT_TEXT(x, y, text) - uses BIOS defaults
    ...
    LDD RESULT
    STD VAR_ARG2
; NATIVE_CALL: VECTREX_PRINT_TEXT at line 9
    JSR VECTREX_PRINT_TEXT
    CLRA
    CLRB
    STD RESULT
...
; ========================================
; NO ASSETS EMBEDDED
; All 7 discovered assets are unused in code
; ========================================
