...
; ROM: 1048576 bytes
; Multibank cartridge: 64 banks (16KB each)
; Helpers bank: 63 (fixed bank at $4000-$7FFF)
...
; Bank 0 ($0000) is active; fixed bank 63 ($4000-$7FFF) always visible
    JMP MAIN
...
LOOP_BODY:
    ...
    LDD RESULT
    STD VAR_ARG1
    LDX #PRINT_TEXT_STR_4937572013524195960      ; Pointer to string in helpers bank
    STX VAR_ARG2
...
PRINT_TEXT_STR_4937572013524195960:
    FCC "64 BANKS - 1MB ROM"
