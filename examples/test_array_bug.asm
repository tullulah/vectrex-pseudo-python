; --- Motorola 6809 backend (Vectrex) title='Test Array Bug' origin=$0000 ---
        ORG $0000
;***************************************************************************
; DEFINE SECTION
;***************************************************************************
...
START:
    ...
    ; VPy_LINE:7
    ; Copy array 'array' from ROM to RAM (3 elements)
    LDX #ARRAY_0       ; Source: ROM array data
    LDU #VAR_ARRAY_DATA ; Dest: RAM array space
    LDD #3        ; Number of elements
COPY_LOOP_0:
...
LOOP_BODY:
    ...
    ; VPy_LINE:14
; NATIVE_CALL: VECTREX_WAIT_RECAL at line 14
    ...
    LDD ,X
    STD RESULT
; NATIVE_CALL: DEBUG_PRINT at line 21
    LDD RESULT
    STA $C002
    STB $C000
    LDA #$42
...
VAR_ARRAY_DATA EQU $C8C0+0  ; Array data (3 elements)
VAR_OFFSET EQU $C8C0+6
...
; Array literal for variable 'array' (3 elements)
ARRAY_0:
    FDB 10   ; Element 0
    FDB 20   ; Element 1
    FDB 30   ; Element 2
