...
// NOTA: Este archivo conserva EmulatorService para compatibilidad; nueva abstracción en `emulatorCore.ts` / `rustWasmCore.ts`.
...
// Herramientas globales se moverán en una fase posterior si se requieren sobre la abstracción.
