...
export type DockComponent = 'files' | 'editor' | 'emulator' | 'debug' | 'errors' | 'output' | 'memory' | 'trace' | 'psglog' | 'bioscalls' | 'ai-assistant' | 'build-output' | 'compiler-output' | 'playground';
