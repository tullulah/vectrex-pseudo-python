...
DCR_DELTA_TABLE:\n\
    ...
    if w.contains("LOAD_LEVEL_RUNTIME") {
        ...
        out.push_str("    \n");
        out.push_str("    ; Copy 18 bytes from X to U (ROM offsets +1 to +7, then +9 to +19)\n");
        out.push_str("    LDD ,X++         ; ROM +1-2 (x) → RAM +0-1\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    LDD ,X++         ; ROM +3-4 (y) → RAM +2-3\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    LDD ,X++         ; ROM +5-6 (scale) → RAM +4-5\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    LDA ,X+          ; ROM +7 (rotation) → RAM +6\n");
        out.push_str("    STA ,U+\n");
        out.push_str("    LEAX 1,X         ; Skip intensity at ROM +8\n");
        out.push_str("    LDD ,X++         ; ROM +9-10 (velocity_x, velocity_y) → RAM +7-8\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    LDD ,X++         ; ROM +11-12 (physics_flags, collision_flags) → RAM +9-10\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    LDD ,X++         ; ROM +13-14 (collision_size, spawn_delay high) → RAM +11-12\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    LDD ,X++         ; ROM +15-16 (spawn_delay low, vector_ptr high) → RAM +13-14\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    LDD ,X++         ; ROM +17-18 (vector_ptr low, properties_ptr high) → RAM +15-16\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    LDA ,X+          ; ROM +19 (properties_ptr low) → RAM +17\n");
        out.push_str("    STA ,U+\n");
        out.push_str("    \n");
    ...
    if w.contains("SHOW_LEVEL_RUNTIME") {
        ...
        out.push_str("    LDA #18          ; RAM objects are 18 bytes (without 'type' and 'intensity' fields)\n");
        ...
        out.push_str("    LDD 2,X          ; y at +2\n");
        out.push_str("    STB DRAW_VEC_Y\n");
        out.push_str("    LDD 0,X          ; x at +0\n");
        out.push_str("    STB DRAW_VEC_X\n");
        out.push_str("    LDU 14,X         ; vector_ptr at +14\n");
    ...
    if w.contains("UPDATE_LEVEL_RUNTIME") {
        ...
        out.push_str("    LDB 9,U      ; Read flags\n");
        out.push_str("    CMPB #0\n");
        ...
        out.push_str("    STB 8,U       ; Store updated velocity_y\n");
        out.push_str("\n");
        out.push_str("ULR_NO_GRAVITY:\n");
        out.push_str("    ; Apply velocity to position\n");
        out.push_str("    ; x += velocity_x\n");
        out.push_str("    LDB 7,U       ; Load velocity_x (signed 8-bit)\n");
        out.push_str("    SEX           ; Sign-extend B to 16-bit in D\n");
        out.push_str("    ADDD 0,U      ; D = x + velocity_x (x at offset +0)\n");
        out.push_str("    STD 0,U       ; Store new x\n");
        out.push_str("\n");
        out.push_str("    ; y += velocity_y\n");
        out.push_str("    LDB 8,U       ; Load velocity_y (signed 8-bit)\n");
        out.push_str("    SEX           ; Sign-extend B to 16-bit in D\n");
        out.push_str("    ADDD 2,U      ; D = y + velocity_y (y at offset +2)\n");
        out.push_str("    STD 2,U       ; Store new y\n");
        out.push_str("\n");
        out.push_str("    ; === Check World Bounds (Wall Collisions) ===\n");
        out.push_str("    LDB 10,U      ; Load collision_flags\n");
        ...
        out.push_str("    STD 0,U       ; x = xMax - collision_size\n");
        out.push_str("    LDB 7,U       ; Reload velocity_x\n");
        out.push_str("    NEGB          ; velocity_x = -velocity_x\n");
        out.push_str("    STB 7,U\n");
        out.push_str("\n");
        ...
        out.push_str("    SEX\n");
        out.push_str("    PSHS D        ; Save collision_size on stack\n");
        out.push_str("    LDD 2,U       ; Load object y\n");
        ...
        out.push_str("    LDB 8,U       ; velocity_y\n");
        out.push_str("    CMPB #0\n");
        ...
        out.push_str("    STD 2,U       ; y = yMin + collision_size\n");
        out.push_str("    LDB 8,U       ; Reload velocity_y\n");
        out.push_str("    NEGB          ; velocity_y = -velocity_y\n");
        out.push_str("    STB 8,U\n");
        out.push_str("\n");
        ...
        out.push_str("    STD 2,U       ; y = yMax - collision_size\n");
        out.push_str("    LDB 8,U       ; Reload velocity_y\n");
        out.push_str("    NEGB          ; velocity_y = -velocity_y\n");
        out.push_str("    STB 8,U\n");
        out.push_str("\n");
        ...
        out.push_str("    LEAU 18,U     ; Move to next object (18 bytes)\n");
        out.push_str("    DECB\n");
        ...
        out.push_str("    \n");
        out.push_str("    ; Calculate Y = LEVEL_GP_BUFFER + (UGPC_INNER_IDX * 18)\n");
        ...
        out.push_str("    \n");
        out.push_str("    LDD 2,U          ; y1\n");
        out.push_str("    SUBD 2,Y         ; y1-y2\n");
        ...
        out.push_str("    LDB 11,U\n");
        out.push_str("    ADDB 11,Y\n");
        ...
        out.push_str("    LDA 7,U          ; A = vel_x of object 1\n");
        out.push_str("    LDB 7,Y          ; B = vel_x of object 2\n");
        out.push_str("    STB 7,U          ; Object 1 gets object 2's vel_x\n");
        out.push_str("    STA 7,Y          ; Object 2 gets object 1's vel_x\n");
        out.push_str("    ; Swap velocity_y\n");
        out.push_str("    LDA 8,U          ; A = vel_y of object 1\n");
        out.push_str("    LDB 8,Y          ; B = vel_y of object 2\n");
        out.push_str("    STB 8,U          ; Object 1 gets object 2's vel_y\n");
        out.push_str("    STA 8,Y          ; Object 2 gets object 1's vel_y\n");
        out.push_str("    \n");
