...
DCR_DELTA_TABLE:\n\
    ...
    if w.contains("LOAD_LEVEL_RUNTIME") {
        ...
        out.push_str("; Load level data from ROM and build dynamic objects index\n");
        ...
        out.push_str(";         LEVEL_DYNAMIC_COUNT = number of dynamic objects found\n");
        out.push_str(";         LEVEL_DYNAMIC_BUFFER = state for dynamic objects (6 bytes each)\n");
        out.push_str("; \n");
        out.push_str("; OPTIMIZATION: Static objects (physicsEnabled=false) are NOT copied to RAM.\n");
        out.push_str("; They remain in ROM and are rendered directly. Only dynamic objects get RAM state.\n");
        out.push_str("; Dynamic state: rom_index(1), pos_x(2), pos_y(2), vel_x(2), vel_y(2), flags(1) = 10 bytes per object\n");
        out.push_str("LOAD_LEVEL_RUNTIME:\n");
        ...
        out.push_str("    \n");
        out.push_str("    ; === Clear dynamic buffer ===\n");
        out.push_str("    CLR LEVEL_DYNAMIC_COUNT\n");
        out.push_str("    LDA #$FF         ; Empty marker\n");
        out.push_str("    LDX #LEVEL_DYNAMIC_BUFFER\n");
        out.push_str("    LDB #120         ; 12 objects * 10 bytes\n");
        out.push_str("LLR_CLEAR_LOOP:\n");
        out.push_str("    STA ,X+\n");
        out.push_str("    DECB\n");
        out.push_str("    BNE LLR_CLEAR_LOOP\n");
        out.push_str("    \n");
        out.push_str("    ; === Scan ALL layers for dynamic objects ===\n");
        out.push_str("    ; U = dynamic buffer write pointer\n");
        out.push_str("    LDU #LEVEL_DYNAMIC_BUFFER\n");
        out.push_str("    \n");
        out.push_str("    ; Scan background layer\n");
        out.push_str("    LDB LEVEL_BG_COUNT\n");
        out.push_str("    BEQ LLR_SKIP_BG_SCAN\n");
        out.push_str("    LDX LEVEL_BG_ROM_PTR\n");
        out.push_str("    LDA #0           ; Start at index 0\n");
        out.push_str("    JSR LLR_SCAN_LAYER\n");
        out.push_str("LLR_SKIP_BG_SCAN:\n");
        out.push_str("    \n");
        out.push_str("    ; Scan gameplay layer\n");
        out.push_str("    LDB LEVEL_GP_COUNT\n");
        out.push_str("    BEQ LLR_SKIP_GP_SCAN\n");
        out.push_str("    LDX LEVEL_GP_ROM_PTR\n");
        out.push_str("    LDA LEVEL_BG_COUNT  ; Offset index by BG count\n");
        out.push_str("    JSR LLR_SCAN_LAYER\n");
        out.push_str("LLR_SKIP_GP_SCAN:\n");
        out.push_str("    \n");
        out.push_str("    ; Scan foreground layer\n");
        out.push_str("    LDB LEVEL_FG_COUNT\n");
        out.push_str("    BEQ LLR_SKIP_FG_SCAN\n");
        out.push_str("    LDX LEVEL_FG_ROM_PTR\n");
        out.push_str("    LDA LEVEL_BG_COUNT\n");
        out.push_str("    ADDA LEVEL_GP_COUNT  ; Offset by BG + GP count\n");
        out.push_str("    JSR LLR_SCAN_LAYER\n");
        out.push_str("LLR_SKIP_FG_SCAN:\n");
        out.push_str("    \n");
        ...
        out.push_str("    \n");
        out.push_str("; === Subroutine: Scan Layer for Dynamic Objects ===\n");
        out.push_str("; Scan ROM objects and copy state for dynamic objects only\n");
        out.push_str("; Input: A = starting rom_index (for this layer)\n");
        out.push_str(";        B = object count in layer\n");
        out.push_str(";        X = ROM pointer to first object in layer\n");
        out.push_str(";        U = dynamic buffer write pointer\n");
        out.push_str("; Output: U = advanced past any added dynamic objects\n");
        out.push_str(";         LEVEL_DYNAMIC_COUNT = updated\n");
        out.push_str("; Object structure in ROM (24 bytes):\n");
        out.push_str(";   +0: type, +1: sprite_id, +2-3: x, +4-5: y\n");
        out.push_str(";   +6-7: width, +8-9: height\n");
        out.push_str(";   +10-11: velocity_x, +12-13: velocity_y\n");
        out.push_str(";   +14-15: flags (bit 0 = physicsEnabled/dynamic)\n");
        out.push_str(";   +16: intensity, +17: scale, +18: rotation, +19: collision_size\n");
        out.push_str(";   +20-21: spawn_delay, +22-23: vector_ptr\n");
        out.push_str("LLR_SCAN_LAYER:\n");
        out.push_str("    PSHS A           ; Save rom_index counter\n");
        out.push_str("LLR_SCAN_LOOP:\n");
        out.push_str("    TSTB\n");
        out.push_str("    BEQ LLR_SCAN_DONE\n");
        out.push_str("    \n");
        out.push_str("    ; Check if dynamic: Read flags at offset +14\n");
        out.push_str("    LDA 14,X         ; A = flags low byte\n");
        out.push_str("    ANDA #$01        ; Test bit 0 (physicsEnabled)\n");
        out.push_str("    BEQ LLR_SCAN_NEXT  ; Skip if static\n");
        out.push_str("    \n");
        out.push_str("    ; Dynamic object found - check if buffer full\n");
        out.push_str("    LDA LEVEL_DYNAMIC_COUNT\n");
        out.push_str("    CMPA #12\n");
        out.push_str("    BHS LLR_SCAN_OVERFLOW  ; Skip if >= 12 (buffer full)\n");
        out.push_str("    \n");
        out.push_str("    ; Copy to dynamic buffer (10 bytes):\n");
        out.push_str("    ; +0: rom_index\n");
        out.push_str("    PULS A           ; Get rom_index\n");
        out.push_str("    STA ,U+\n");
        out.push_str("    PSHS A           ; Save it back\n");
        out.push_str("    \n");
        out.push_str("    ; +1-2: position_x (from ROM offset +2-3)\n");
        out.push_str("    LDD 2,X\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    \n");
        out.push_str("    ; +3-4: position_y (from ROM offset +4-5)\n");
        out.push_str("    LDD 4,X\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    \n");
        out.push_str("    ; +5-6: velocity_x (from ROM offset +10-11)\n");
        out.push_str("    LDD 10,X\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    \n");
        out.push_str("    ; +7-8: velocity_y (from ROM offset +12-13)\n");
        out.push_str("    LDD 12,X\n");
        out.push_str("    STD ,U++\n");
        out.push_str("    \n");
        out.push_str("    ; +9: active_flags (initialize to 0x01 = active)\n");
        out.push_str("    LDA #$01\n");
        out.push_str("    STA ,U+\n");
        out.push_str("    \n");
        out.push_str("    ; Increment dynamic count\n");
        out.push_str("    INC LEVEL_DYNAMIC_COUNT\n");
        out.push_str("    \n");
        out.push_str("LLR_SCAN_NEXT:\n");
        out.push_str("    ; Advance to next object (24 bytes)\n");
        out.push_str("    LEAX 24,X\n");
        out.push_str("    \n");
        out.push_str("    ; Increment rom_index\n");
        out.push_str("    PULS A\n");
        out.push_str("    INCA\n");
        out.push_str("    PSHS A\n");
        out.push_str("    \n");
        out.push_str("    DECB\n");
        out.push_str("    BRA LLR_SCAN_LOOP\n");
        out.push_str("    \n");
        out.push_str("LLR_SCAN_OVERFLOW:\n");
        out.push_str("    ; Buffer full - skip remaining objects\n");
        out.push_str("    ; TODO: Could emit warning/error in debug builds\n");
        out.push_str("LLR_SCAN_DONE:\n");
        out.push_str("    PULS A,PC        ; Restore and return\n");
        out.push_str("\n");
    }
    
    if w.contains("SHOW_LEVEL_RUNTIME") {
        out.push_str("; === SHOW_LEVEL_RUNTIME ===\n");
        out.push_str("; Draw all level objects using ROM-first optimization\n");
        out.push_str("; Phase 1: Draw static objects directly from ROM (0 RAM overhead)\n");
        out.push_str("; Phase 2: Draw dynamic objects from LEVEL_DYNAMIC_BUFFER\n");
        ...
        out.push_str("    LDX LEVEL_PTR\n");
        out.push_str("    CMPX #0\n");
        out.push_str("    LBEQ SLR_DONE    ; No level loaded (long branch)\n");
        out.push_str("    \n");
        out.push_str("    ; === PHASE 1: Draw Static Objects from ROM ===\n");
        out.push_str("    ; Skip to layer pointers (12 bytes header + 3 bytes counts)\n");
        out.push_str("    LEAX 15,X\n");
        out.push_str("    \n");
        out.push_str("    ; Draw background layer (static only)\n");
        out.push_str("    LDB LEVEL_BG_COUNT\n");
        out.push_str("    BEQ SLR_SKIP_BG_STATIC\n");
        out.push_str("    LDX LEVEL_BG_ROM_PTR\n");
        out.push_str("    JSR SLR_DRAW_STATIC_LAYER\n");
        out.push_str("SLR_SKIP_BG_STATIC:\n");
        out.push_str("    \n");
        out.push_str("    ; Draw gameplay layer (static only)\n");
        out.push_str("    LDB LEVEL_GP_COUNT\n");
        out.push_str("    BEQ SLR_SKIP_GP_STATIC\n");
        out.push_str("    LDX LEVEL_GP_ROM_PTR\n");
        out.push_str("    JSR SLR_DRAW_STATIC_LAYER\n");
        out.push_str("SLR_SKIP_GP_STATIC:\n");
        out.push_str("    \n");
        out.push_str("    ; Draw foreground layer (static only)\n");
        out.push_str("    LDB LEVEL_FG_COUNT\n");
        out.push_str("    BEQ SLR_SKIP_FG_STATIC\n");
        out.push_str("    LDX LEVEL_FG_ROM_PTR\n");
        out.push_str("    JSR SLR_DRAW_STATIC_LAYER\n");
        out.push_str("SLR_SKIP_FG_STATIC:\n");
        out.push_str("    \n");
        out.push_str("    ; === PHASE 2: Draw Dynamic Objects from RAM ===\n");
        out.push_str("    LDB LEVEL_DYNAMIC_COUNT\n");
        ...
        out.push_str("; Input: B = object count, X = ROM pointer to first object\n");
        out.push_str("; Skips objects with physicsEnabled flag (those are in dynamic buffer)\n");
        out.push_str("SLR_DRAW_STATIC_LAYER:\n");
        out.push_str("    TSTB\n");
        out.push_str("    BEQ SLR_DSL_DONE\n");
        out.push_str("    PSHS B\n");
        out.push_str("    \n");
        out.push_str("    ; Check if dynamic (offset +14, bit 0)\n");
        out.push_str("    LDA 14,X\n");
        out.push_str("    ANDA #$01\n");
        out.push_str("    BNE SLR_DSL_SKIP  ; Skip if dynamic\n");
        out.push_str("    \n");
        out.push_str("    ; Static object - draw from ROM\n");
        out.push_str("    JSR SLR_DRAW_ONE_OBJECT  ; X = ROM pointer\n");
        out.push_str("    \n");
        out.push_str("SLR_DSL_SKIP:\n");
        out.push_str("    ; Advance to next object (24 bytes)\n");
        out.push_str("    LEAX 24,X\n");
        out.push_str("    PULS B\n");
        out.push_str("    DECB\n");
        out.push_str("    BRA SLR_DRAW_STATIC_LAYER\n");
        out.push_str("    \n");
        out.push_str("SLR_DSL_DONE:\n");
        out.push_str("    RTS\n");
        out.push_str("    \n");
        out.push_str("; === SLR_DRAW_DYNAMIC_OBJECTS: Draw from dynamic buffer ===\n");
        out.push_str("; Input: B = dynamic count, U = LEVEL_DYNAMIC_BUFFER\n");
        out.push_str("; Reads position from RAM (not ROM) since objects have moved\n");
        out.push_str("SLR_DRAW_DYNAMIC_OBJECTS:\n");
        out.push_str("    TSTB\n");
        out.push_str("    LBEQ SLR_DDO_DONE\n");
        out.push_str("    PSHS B\n");
        out.push_str("    \n");
        out.push_str("    ; Dynamic buffer entry (10 bytes):\n");
        out.push_str("    ; +0: rom_index, +1-2: pos_x, +3-4: pos_y, +5-6: vel_x, +7-8: vel_y, +9: flags\n");
        out.push_str("    \n");
        out.push_str("    ; Get rom_index and calculate ROM offset\n");
        out.push_str("    LDA ,U+          ; A = rom_index\n");
        out.push_str("    PSHS U           ; Save dynamic buffer pos\n");
        out.push_str("    \n");
        out.push_str("    ; Calculate ROM pointer: rom_index * 24\n");
        out.push_str("    ; First determine which layer this index belongs to\n");
        out.push_str("    LDB LEVEL_BG_COUNT\n");
        out.push_str("    CMPB A\n");
        out.push_str("    BHI SLR_DDO_IN_BG  ; If index < bgCount, it's in BG\n");
        out.push_str("    \n");
        out.push_str("    ; Not in BG, check GP\n");
        out.push_str("    ADDB LEVEL_GP_COUNT  ; B = bgCount + gpCount\n");
        out.push_str("    CMPB A\n");
        out.push_str("    BHI SLR_DDO_IN_GP  ; If index < bgCount+gpCount, it's in GP\n");
        out.push_str("    \n");
        out.push_str("    ; Must be in FG\n");
        out.push_str("    LDX LEVEL_FG_ROM_PTR\n");
        out.push_str("    LDB LEVEL_BG_COUNT\n");
        out.push_str("    ADDB LEVEL_GP_COUNT\n");
        out.push_str("    BRA SLR_DDO_CALC_OFFSET\n");
        out.push_str("    \n");
        out.push_str("SLR_DDO_IN_BG:\n");
        out.push_str("    LDX LEVEL_BG_ROM_PTR\n");
        out.push_str("    CLRB             ; Offset from start of layer\n");
        out.push_str("    BRA SLR_DDO_CALC_OFFSET\n");
        out.push_str("    \n");
        out.push_str("SLR_DDO_IN_GP:\n");
        out.push_str("    LDX LEVEL_GP_ROM_PTR\n");
        out.push_str("    LDB LEVEL_BG_COUNT\n");
        out.push_str("    \n");
        out.push_str("SLR_DDO_CALC_OFFSET:\n");
        out.push_str("    ; A = rom_index, B = layer_base_index, X = layer ROM ptr\n");
        out.push_str("    PSHS A\n");
        out.push_str("    SUBA B           ; A = index within layer\n");
        out.push_str("    ; Multiply by 24: A = A * 24 = A * 16 + A * 8\n");
        out.push_str("    TFR A,B          ; Save original A\n");
        out.push_str("    LSLB\n");
        out.push_str("    LSLB\n");
        out.push_str("    LSLB             ; B = A * 8\n");
        out.push_str("    PSHS B           ; Save A*8\n");
        out.push_str("    TFR A,B          ; B = original A\n");
        out.push_str("    LSLB\n");
        out.push_str("    LSLB\n");
        out.push_str("    LSLB\n");
        out.push_str("    LSLB             ; B = A * 16\n");
        out.push_str("    ADDB ,S+         ; B = A*16 + A*8 = A*24, pop stack\n");
        out.push_str("    CLRA             ; Clear high byte\n");
        out.push_str("    LEAX D,X         ; X = X + (A*24)\n");
        out.push_str("    PULS A           ; Get rom_index back\n");
        out.push_str("    PULS U           ; Restore dynamic buffer position\n");
        out.push_str("    \n");
        out.push_str("    ; Override position with RAM values (objects have moved!)\n");
        out.push_str("    ; Read pos_x from U+0-1 (U now points after rom_index)\n");
        out.push_str("    LDD ,U++\n");
        out.push_str("    STB DRAW_VEC_X   ; Store X position (LSB)\n");
        out.push_str("    \n");
        out.push_str("    ; Read pos_y from U+0-1 (U advanced)\n");
        out.push_str("    LDD ,U++\n");
        out.push_str("    STB DRAW_VEC_Y   ; Store Y position (LSB)\n");
        out.push_str("    \n");
        out.push_str("    ; Skip velocity (4 bytes) and flags (1 byte)\n");
        out.push_str("    LEAU 5,U\n");
        out.push_str("    \n");
        out.push_str("    ; Read intensity and vector_ptr from ROM (X points to ROM object)\n");
        out.push_str("    LDA 16,X         ; Intensity from ROM\n");
        out.push_str("    STA DRAW_VEC_INTENSITY\n");
        out.push_str("    \n");
        out.push_str("    LDY 22,X         ; Vector pointer from ROM (offset +22-23)\n");
        out.push_str("    PSHS U           ; Save dynamic buffer pos\n");
        out.push_str("    TFR Y,X          ; X = vector data\n");
        out.push_str("    \n");
        out.push_str("    ; Clear mirrors\n");
        out.push_str("    CLR MIRROR_X\n");
        out.push_str("    CLR MIRROR_Y\n");
        out.push_str("    \n");
        out.push_str("    ; Draw paths\n");
        out.push_str("    LDB ,X+          ; B = path_count\n");
        out.push_str("    PSHS B\n");
        out.push_str("SLR_DDO_PATH_LOOP:\n");
        out.push_str("    PULS B\n");
        out.push_str("    TSTB\n");
        out.push_str("    LBEQ SLR_DDO_PATH_DONE\n");
        out.push_str("    DECB\n");
        out.push_str("    PSHS B\n");
        out.push_str("    LDY ,X++         ; Read path pointer\n");
        out.push_str("    PSHS X\n");
        out.push_str("    TFR Y,X\n");
        out.push_str("    JSR Draw_Sync_List_At_With_Mirrors\n");
        out.push_str("    PULS X\n");
        out.push_str("    BRA SLR_DDO_PATH_LOOP\n");
        out.push_str("SLR_DDO_PATH_DONE:\n");
        out.push_str("    \n");
        out.push_str("    PULS U           ; Restore dynamic buffer position\n");
        out.push_str("    PULS B\n");
        out.push_str("    DECB\n");
        out.push_str("    LBRA SLR_DRAW_DYNAMIC_OBJECTS\n");
        out.push_str("    \n");
        out.push_str("SLR_DDO_DONE:\n");
        out.push_str("    RTS\n");
        out.push_str("    \n");
        out.push_str("; === SLR_DRAW_ONE_OBJECT: Draw single object from ROM ===\n");
        out.push_str("; Input: X = ROM pointer to object (24 bytes)\n");
        out.push_str("; Reads position, intensity, vector_ptr from ROM\n");
        out.push_str("SLR_DRAW_ONE_OBJECT:\n");
        out.push_str("    ; Read position from ROM\n");
        out.push_str("    LDD 2,X          ; X position (offset +2-3)\n");
        out.push_str("    STB DRAW_VEC_X\n");
        out.push_str("    LDD 4,X          ; Y position (offset +4-5)\n");
        out.push_str("    STB DRAW_VEC_Y\n");
        out.push_str("    \n");
        out.push_str("    ; Read intensity\n");
        out.push_str("    LDA 16,X\n");
        out.push_str("    STA DRAW_VEC_INTENSITY\n");
        out.push_str("    \n");
        out.push_str("    ; Clear mirrors\n");
        out.push_str("    CLR MIRROR_X\n");
        out.push_str("    CLR MIRROR_Y\n");
        out.push_str("    \n");
        out.push_str("    ; Read vector_ptr (offset +22-23)\n");
        out.push_str("    PSHS X           ; Save object pointer\n");
        out.push_str("    LDX 22,X         ; X = vector data pointer\n");
        out.push_str("    \n");
        out.push_str("    ; Draw all paths\n");
        out.push_str("    LDB ,X+          ; B = path_count\n");
        out.push_str("    PSHS B\n");
        out.push_str("SLR_DOO_PATH_LOOP:\n");
        out.push_str("    PULS B\n");
        out.push_str("    TSTB\n");
        out.push_str("    BEQ SLR_DOO_PATH_DONE\n");
        out.push_str("    DECB\n");
        out.push_str("    PSHS B\n");
        out.push_str("    LDU ,X++         ; Read path pointer\n");
        out.push_str("    PSHS X\n");
        out.push_str("    TFR U,X\n");
        out.push_str("    JSR Draw_Sync_List_At_With_Mirrors\n");
        out.push_str("    PULS X\n");
        out.push_str("    BRA SLR_DOO_PATH_LOOP\n");
        out.push_str("SLR_DOO_PATH_DONE:\n");
        out.push_str("    \n");
    ...
    // UPDATE_LEVEL_RUNTIME - Update dynamic objects only
    if w.contains("UPDATE_LEVEL_RUNTIME") {
        out.push_str("; === UPDATE_LEVEL_RUNTIME ===\n");
        out.push_str("; Update level state (physics, velocity) for dynamic objects ONLY\n");
        out.push_str("; Static objects don't need updates (they never move)\n");
        out.push_str("; Operates on LEVEL_DYNAMIC_BUFFER (10 bytes per object)\n");
        out.push_str("UPDATE_LEVEL_RUNTIME:\n");
        out.push_str("    PSHS U,X,Y,D  ; Preserve all registers\n");
        out.push_str("    \n");
        out.push_str("    ; Check if any dynamic objects exist\n");
        out.push_str("    LDB LEVEL_DYNAMIC_COUNT\n");
        out.push_str("    BEQ ULR_EXIT\n");
        out.push_str("    \n");
        out.push_str("    ; Get world bounds for collision checks\n");
        out.push_str("    LDX LEVEL_PTR\n");
        out.push_str("    CMPX #0\n");
        out.push_str("    BEQ ULR_EXIT  ; No level loaded\n");
        out.push_str("    \n");
        out.push_str("    ; U = dynamic buffer pointer\n");
        out.push_str("    LDU #LEVEL_DYNAMIC_BUFFER\n");
        out.push_str("    \n");
        ...
        out.push_str("    ; +0: rom_index, +1-2: pos_x, +3-4: pos_y, +5-6: vel_x, +7-8: vel_y, +9: flags\n");
        out.push_str("    \n");
        out.push_str("    PSHS B           ; Save counter\n");
        out.push_str("    \n");
        out.push_str("    ; Skip rom_index\n");
        out.push_str("    LEAU 1,U\n");
        out.push_str("    \n");
        out.push_str("    ; Apply velocity: pos_x += vel_x\n");
        out.push_str("    LDD ,U           ; Load pos_x (offset +0-1 after rom_index)\n");
        out.push_str("    ADDD 4,U         ; Add vel_x (offset +4-5)\n");
        out.push_str("    STD ,U           ; Store new pos_x\n");
        out.push_str("    \n");
        out.push_str("    ; Apply velocity: pos_y += vel_y\n");
        out.push_str("    LDD 2,U          ; Load pos_y (offset +2-3)\n");
        out.push_str("    ADDD 6,U         ; Add vel_y (offset +6-7)\n");
        out.push_str("    STD 2,U          ; Store new pos_y\n");
        out.push_str("    \n");
        out.push_str("    ; === Check World Bounds (Wall Collisions) ===\n");
        out.push_str("    ; Simplified: Bounce if position exceeds bounds\n");
        out.push_str("    \n");
        out.push_str("    ; Check X bounds (xMin at X+0, xMax at X+2)\n");
        out.push_str("    LDD ,U           ; pos_x\n");
        out.push_str("    CMPD 0,X         ; Compare with xMin\n");
        out.push_str("    BGE ULR_X_MAX_CHECK\n");
        out.push_str("    ; Hit xMin - clamp position and negate velocity\n");
        out.push_str("    LDD 0,X\n");
        out.push_str("    STD ,U           ; pos_x = xMin\n");
        out.push_str("    LDD 4,U          ; vel_x\n");
        out.push_str("    NEGA\n");
        out.push_str("    NEGB\n");
        out.push_str("    SBCA #0\n");
        out.push_str("    STD 4,U          ; vel_x = -vel_x\n");
        out.push_str("    \n");
        out.push_str("ULR_X_MAX_CHECK:\n");
        out.push_str("    LDD ,U           ; pos_x\n");
        out.push_str("    CMPD 2,X         ; Compare with xMax\n");
        out.push_str("    BLE ULR_Y_MIN_CHECK\n");
        out.push_str("    ; Hit xMax - clamp position and negate velocity\n");
        out.push_str("    LDD 2,X\n");
        out.push_str("    STD ,U           ; pos_x = xMax\n");
        out.push_str("    LDD 4,U          ; vel_x\n");
        out.push_str("    NEGA\n");
        out.push_str("    NEGB\n");
        out.push_str("    SBCA #0\n");
        out.push_str("    STD 4,U          ; vel_x = -vel_x\n");
        out.push_str("    \n");
        out.push_str("    ; Check Y bounds (yMin at X+4, yMax at X+6)\n");
        out.push_str("ULR_Y_MIN_CHECK:\n");
        out.push_str("    LDD 2,U          ; pos_y\n");
        out.push_str("    CMPD 4,X         ; Compare with yMin\n");
        out.push_str("    BGE ULR_Y_MAX_CHECK\n");
        out.push_str("    ; Hit yMin - clamp position and negate velocity\n");
        out.push_str("    LDD 4,X\n");
        out.push_str("    STD 2,U          ; pos_y = yMin\n");
        out.push_str("    LDD 6,U          ; vel_y\n");
        out.push_str("    NEGA\n");
        out.push_str("    NEGB\n");
        out.push_str("    SBCA #0\n");
        out.push_str("    STD 6,U          ; vel_y = -vel_y\n");
        out.push_str("    \n");
        out.push_str("ULR_Y_MAX_CHECK:\n");
        out.push_str("    LDD 2,U          ; pos_y\n");
        out.push_str("    CMPD 6,X         ; Compare with yMax\n");
        out.push_str("    BLE ULR_NEXT\n");
        out.push_str("    ; Hit yMax - clamp position and negate velocity\n");
        out.push_str("    LDD 6,X\n");
        out.push_str("    STD 2,U          ; pos_y = yMax\n");
        out.push_str("    LDD 6,U          ; vel_y\n");
        out.push_str("    NEGA\n");
        out.push_str("    NEGB\n");
        out.push_str("    SBCA #0\n");
        ...
        out.push_str("    ; Advance to next dynamic object (10 bytes total)\n");
        out.push_str("    LEAU 9,U         ; Skip remaining bytes (already skipped rom_index)\n");
        out.push_str("    \n");
        out.push_str("    PULS B\n");
        out.push_str("    DECB\n");
        out.push_str("    BNE ULR_LOOP\n");
        out.push_str("    \n");
