...
fn constant_folding_add_mul_identities() {
    ...
    Stmt::Let { name: "b".into(), value: Expr::Binary { op: BinOp::Mul, left: Box::new(Expr::Number(1)), right: Box::new(Expr::Ident(IdentInfo { name:"a".into(), line:0, col:0 })) } },
    Stmt::Return(Some(Expr::Ident(IdentInfo { name:"b".into(), line:0, col:0 })))
    ]};
...
fn dead_store_elimination_basic() {
    ...
    Stmt::Assign { target: AssignTarget { name: "x".into(), line:0, col:0 }, value: Expr::Number(2) },
