...
fn firq_after_irq_unmask() {
    ...
    cpu.mem[0xFFF4] = 0x20; cpu.mem[0xFFF5] = 0x02; cpu.bus.mem[0xFFF4] = 0x20; cpu.bus.mem[0xFFF5] = 0x02;

    // IRQ handler at 0x0200:
    // 0200: ANDCC #$EF  (clear I to allow new interrupts)
    // 0202: LDA #$55    (some work)
    // 0204: RTI         (end IRQ)
    cpu.mem[0x0200] = 0x1C; cpu.bus.mem[0x0200] = 0x1C; // ANDCC
    cpu.mem[0x0201] = 0xEF; cpu.bus.mem[0x0201] = 0xEF; // clear I
    cpu.mem[0x0202] = 0x86; cpu.bus.mem[0x0202] = 0x86; // LDA #
    cpu.mem[0x0203] = 0x55; cpu.bus.mem[0x0203] = 0x55;
    cpu.mem[0x0204] = 0x3B; cpu.bus.mem[0x0204] = 0x3B; // RTI

    // FIRQ handler at 0x0220:
    // 0220: LDB #$AA
    // 0222: RTI (partial frame)
    cpu.mem[0x0220] = 0xC6; cpu.bus.mem[0x0220] = 0xC6; // LDB #
    cpu.mem[0x0221] = 0xAA; cpu.bus.mem[0x0221] = 0xAA;
    cpu.mem[0x0222] = 0x3B; cpu.bus.mem[0x0222] = 0x3B; // RTI

    // Main code at 0x0100: LDA #$01; (will be pre-empted by IRQ before executing if irq_pending set early)
    cpu.pc = 0x0100;
    cpu.mem[0x0100] = 0x86; cpu.bus.mem[0x0100] = 0x86; cpu.mem[0x0101] = 0x01; cpu.bus.mem[0x0101] = 0x01;
