...
fn tfr_16bit_x_to_y() {
    ...
    cpu.mem[0x0100] = 0x1F; cpu.bus.mem[0x0100] = 0x1F;
    cpu.mem[0x0101] = 0x12; cpu.bus.mem[0x0101] = 0x12;
    cpu.step();
...
fn exg_8bit_a_b() {
    ...
    cpu.mem[0x0100] = 0x1E; cpu.bus.mem[0x0100] = 0x1E;
    cpu.mem[0x0101] = 0x89; cpu.bus.mem[0x0101] = 0x89;
    cpu.step();
...
fn exg_invalid_mixed_width_rejected() {
    ...
    cpu.mem[0x0100] = 0x1E; cpu.bus.mem[0x0100] = 0x1E;
    cpu.mem[0x0101] = 0x81; cpu.bus.mem[0x0101] = 0x81;
    let ok = cpu.step();
