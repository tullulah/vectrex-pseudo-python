...
fn pshu_pulu_roundtrip() {
    ...
    cpu.bus.mem[0x0100] = 0x36; cpu.bus.mem[0x0100] = 0x36; // PSHU
    ...
    cpu.bus.mem[0x0104] = 0x37; cpu.bus.mem[0x0104] = 0x37; // PULU
    cpu.bus.mem[0x0105] = 0x9F; cpu.bus.mem[0x0105] = 0x9F;
