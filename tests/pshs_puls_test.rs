...
fn pshs_puls_roundtrip() {
    ...
    cpu.bus.mem[0x0100] = 0x34; cpu.bus.mem[0x0100] = 0x34; // PSHS
    cpu.bus.mem[0x0101] = 0x9F; cpu.bus.mem[0x0101] = 0x9F;
    cpu.bus.mem[0x0102] = 0x86; cpu.bus.mem[0x0102] = 0x86; // LDA #
    cpu.bus.mem[0x0103] = 0x99; cpu.bus.mem[0x0103] = 0x99;
    cpu.bus.mem[0x0104] = 0xC6; cpu.bus.mem[0x0104] = 0xC6; // LDB #
    cpu.bus.mem[0x0105] = 0x55; cpu.bus.mem[0x0105] = 0x55;
    cpu.bus.mem[0x0106] = 0x35; cpu.bus.mem[0x0106] = 0x35; // PULS
    cpu.bus.mem[0x0107] = 0x9F; cpu.bus.mem[0x0107] = 0x9F;
